...
const USER_CONFIG = {
  ...
  // 如果你非要填这里也行。脚本也能运行
  APP_ID: 'wxbcf3daa6fe28d319',

  // 公众号APP_SECRET
  // 建议不要填这里，请使用文档中github secret的方法进行保密配置，保护您的隐私安全。
  // 如果你非要填这里也行。脚本也能运行
  APP_SECRET: '63b7fc12c33f8961628dd6a3831c18f5',
  ...
  USERS: [
    {
      ...
      id: 'oRNrp56Use_W5JSCoZapw9ynO5gs	',
      // 你想对他发送的模板消息的模板ID
      useTemplateId: 'Xc7CPLuCIv-FbJNc-1EpcXbYEXHphuQS7-YX5vGYn3s',
      // 所在省份
      province: '湖南',
      // 所在城市
      city: '邵阳',
